...
<%
    ...
    Photographer userC = (Photographer) session.getAttribute("photographer");
        ...
        <div class="main-content">
            <header class="glass-card">
                ...
                <div class="user-info">
                    ...
                    <div class="user-avatar">
                        <% if (userC != null) { %>                  		
                    		<img src="displayProfilePic?targetName=<%= userC.getUsername() %>" alt="Profile Picture" id="profile-picture">
                        <% } else { %>
			...
			%>
                <div class="profile-section">
                    <div class="header">
        <button type="button" id="edit-profile-btn" class="btn-animated" onclick="window.location.href='photographer_chatList.jsp'"><i class="fas fa-arrow-left"></i> Back</button>
        <div class="user-avatar">               		
             <img src="displayProfilePicUSER?targetName=<%= selectedUsername %>" alt="Profile Picture" id="profile-picture">
         </div>
